...
const TORSO_HALF =
  ...
  'C56,120 58,121 60,124 C60,134 59,142 58,150 C58,162 60,174 62,186 ' +
  'C64,194 66,200 66,206 C65,216 61,226 58,234 C58,254 59,276 60,296 ' +
  'C61,312 62,322 63,332 C64,356 65,386 66,410 C66,422 67,431 68,438 ' +
  'C64,444 62,451 64,455 C67,459 82,459 86,455 C89,451 88,444 86,438 ' +
  'C87,414 88,388 89,362 C90,336 93,300 96,270 C97,255 98,244 100,236 Z';
 ...
 */
const ARM_HALF =
  'M68,96 C60,97 57,98 52,101 C44,104 34,109 27,116 C23,120 20,124 20,130 ' +
  'C19,140 18,150 18,158 C17,168 16,176 15,184 C14,192 14,200 14,206 ' +
  'C14,214 18,221 24,221 C30,221 35,216 36,209 C37,202 37,196 37,190 ' +
  'C38,180 39,170 40,160 C41,148 43,136 45,128 C47,122 50,120 53,118 ' +
  'C57,110 62,102 68,96 Z';
