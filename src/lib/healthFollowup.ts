...
/**
 * 신체도 표시 순서 = 위(머리)에서 아래(복부)로. 연결선이 서로 엇갈리지 않도록
 * 지점의 y 순서와 오른쪽 설명 줄의 순서를 같게 맞춰 둔다.
 */
export const BODY_POINTS: BodyPoint[] = [
  // 정면에서 본 위치 — 보는 사람 기준으로 좌우가 뒤집힌다.
  // (심장·위는 본인 왼쪽 = 화면 오른쪽, 간은 본인 오른쪽 = 화면 왼쪽)
  { key: 'brain', label: '뇌·신경', x: 100, y: 32, keywords: ['두통', '어지럼', '뇌', '신경'] },
  { key: 'lungs', label: '호흡기', x: 86, y: 136, keywords: ['흉부', '폐', '호흡', '결핵', '천식', '기관지'] },
  { key: 'heart', label: '심장·혈압', x: 112, y: 154, keywords: ['고혈압', '혈압', '심장', '순환', '부정맥', '빈혈'] },
  { key: 'liver', label: '간·대사', x: 80, y: 180, keywords: ['간', '지방간', '당뇨', '대사', '이상지질', '콜레스테롤', '비만'] },
  { key: 'stomach', label: '위장관', x: 116, y: 192, keywords: ['위', '소화', '위장', '역류'] },
  { key: 'gut', label: '장', x: 100, y: 220, keywords: ['장질환', '대장', '변비', '설사', '치질'] },
];
