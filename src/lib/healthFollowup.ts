...
export const BODY_POINTS: BodyPoint[] = [
  ...
  { key: 'lungs', label: '호흡기', x: 118, y: 132, keywords: ['흉부', '폐', '호흡', '결핵', '천식', '기관지'] },
  { key: 'heart', label: '심장·혈압', x: 86, y: 148, keywords: ['고혈압', '혈압', '심장', '순환', '부정맥', '빈혈'] },
  { key: 'liver', label: '간·대사', x: 118, y: 190, keywords: ['간', '지방간', '당뇨', '대사', '이상지질', '콜레스테롤', '비만'] },
  { key: 'stomach', label: '위장관', x: 84, y: 202, keywords: ['위', '소화', '위장', '역류'] },
  { key: 'gut', label: '장', x: 100, y: 234, keywords: ['장질환', '대장', '변비', '설사', '치질'] },
];
